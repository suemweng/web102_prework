...
const unfundedString = `A total of $${totalRaised.toLocaleString('en-US')} has been raised for 
${GAMES_JSON.length.toLocaleString('en-US')} games. Currently, ${unfundedCount === 1 ? "1 game remains" : unfundedCount + " games remain"}
unfunded. We need your help to fund these amazing games!`;

// create a new DOM element containing the template string and append it to the description container
const descriptionPara = document.createElement("p");
descriptionPara.innerHTML = unfundedString;
